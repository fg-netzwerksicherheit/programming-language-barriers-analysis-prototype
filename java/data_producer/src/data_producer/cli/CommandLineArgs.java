...
package data_producer.cli;

import uk.co.flamingpenguin.jewel.cli.Option;

public interface CommandLineArgs {

    @Option(defaultValue = "1", shortName = "b", description = "Producer data in bulks of the given size.")
    int getBulkSize();
    ...
    @Option(description = "Method used connecting the data generator and the consumer."
            + "Available values are: fifo, net_tcp, jni, no_op", shortName = "m", defaultValue = "fifo")
